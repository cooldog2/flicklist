...
var api = {
  ...
  token: "3aea9009062fefbc3066d1f619e05f40", // TODO 0 add your api key (DONE)
  /**
...
// TODO 1
// this function should accept a second argument, `keywords`  - added 2nd argument to function
...
function searchMovies(query, callback) {
  ...
  // HINT use the array map function to map over response.results
    ...
    //keywordObj represents the oldThing
  ...
  $.ajax({
    url: api.root + "/search/keyword",   //4a changed from "/search/movies" to "search/keywords"
    data: {
      api_key: api.token,
      query: query
    },
